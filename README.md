...
[![Gitter](https://badges.gitter.im/Join%20Chat.svg)](https://gitter.im/Wolox/async-request-demo?utm_source=badge&utm_medium=badge&utm_campaign=pr-badge&utm_content=badge)
[![Error Tracking](https://d26gfdfi90p7cf.cloudfront.net/rollbar-badge.144534.o.png)](https://rollbar.com)

`[![Codestats](http://codestats-url/organizations/your-organization/projects/async-request-demo/badge)](http://codestats-url/organizations/your-organization/projects/async-request-demo/badge)`
...
- Clone the repository by running `git clone git@github.com:Wolox/async-request-demo.git`
- Go to the project root by running `cd async-request-demo`
...
```bash
  ...
  CREATE ROLE "async-request-demo" LOGIN CREATEDB PASSWORD 'async-request-demo';
```
